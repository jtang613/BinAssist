...
class EdgeType(str, Enum):
    ...
    NETWORK_SEND_PATH = "network_send_path"

    # Network data flow - path from recv function to its consumers
    NETWORK_RECV_PATH = "network_recv_path"

    # Network send edge - direct connection from caller to send API
    NETWORK_SEND = "network_send"

    # Network recv edge - direct connection from recv API to caller
    ...
    def is_security(self) -> bool:
        ...
        return self in {
            ...
            EdgeType.CALLS_VULNERABLE, EdgeType.NETWORK_SEND_PATH,
            EdgeType.NETWORK_RECV_PATH, EdgeType.NETWORK_SEND,
